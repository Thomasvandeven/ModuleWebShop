package be.module.eShop.webshop.web;
...
import be.module.eShop.webshop.service.UserService;
import be.module.eShop.webshop.web.model.AddCustomerModel;
import be.module.eShop.webshop.web.model.AddProductModel;
import be.module.eShop.webshop.web.model.AdminOrderModel;
import be.module.eShop.webshop.web.model.CategoriesModel;
import be.module.eShop.webshop.web.model.LoginFormModel;
import be.module.eShop.webshop.web.model.ProductModel;
import be.module.eShop.webshop.web.model.ProductsModel;
import be.module.eShop.webshop.web.model.SearchModel;
...
public class MainController {
  ...
  public String adminAddProduct(Model model) {
    ...
    return "dear your product add request is proved " + "adminAddProduct";
  }
