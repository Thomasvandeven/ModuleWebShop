package be.module.eShop.webshop.service;

import java.util.ArrayList;
import java.util.List;
import java.util.Optional;

import be.module.eShop.webshop.repository.CategoryRepository;
import be.module.eShop.webshop.repository.CustomerRepository;
import be.module.eShop.webshop.repository.OrderRepository;
import be.module.eShop.webshop.web.model.AddProductModel;
import be.module.eShop.webshop.web.model.ProductModel;
import be.module.eShop.webshop.web.model.ShoppingCartModel;
...
import be.module.eShop.webshop.repository.ProductRepository;
